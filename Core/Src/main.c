...
uint16_t ADC_Data; //value coming from the ADC
uint8_t throttle_value;   // the strength value of the Padel
...
uint32_t T_firstState = 0 ;
uint32_t T_secondState = 0;
uint16_t HALL_OVERSAMPLE=0;

uint32_t time_interval = 0;
float time_interval_minutes;
uint8_t count=1;
